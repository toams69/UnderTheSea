...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFWaveParameter
{
	...
	IMPLEMENT_CLASS(AOceanManager, 42301178);
...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFBuoyancyVertex
{
	...
	{
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "ApplyForce",(Native)&UAdvancedBuoyancyComponent::execApplyForce);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "ApplySlamForce",(Native)&UAdvancedBuoyancyComponent::execApplySlamForce);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "DrawDebugStuff",(Native)&UAdvancedBuoyancyComponent::execDrawDebugStuff);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "GetOcean",(Native)&UAdvancedBuoyancyComponent::execGetOcean);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "GetOceanDepthFromGrid",(Native)&UAdvancedBuoyancyComponent::execGetOceanDepthFromGrid);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "SetMeshDensity",(Native)&UAdvancedBuoyancyComponent::execSetMeshDensity);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "SplitTriangle",(Native)&UAdvancedBuoyancyComponent::execSplitTriangle);
		FNativeFunctionRegistrar::RegisterFunction(UAdvancedBuoyancyComponent::StaticClass(), "TriangleArea",(Native)&UAdvancedBuoyancyComponent::execTriangleArea);
	}
	IMPLEMENT_CLASS(UAdvancedBuoyancyComponent, 1429789255);
	void UBuoyancyComponent::StaticRegisterNativesUBuoyancyComponent()
	{
	}
	IMPLEMENT_CLASS(UBuoyancyComponent, 2308022401);
...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFStructBoneOverride
{
	...
	IMPLEMENT_CLASS(ACustomVehicleController, 2354653476);
	void AFishManager::StaticRegisterNativesAFishManager()
	{
	}
	IMPLEMENT_CLASS(AFishManager, 2482664489);
	...
	IMPLEMENT_CLASS(AFlockFish, 2235507843);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFollowMethod(EFollowMethod_StaticEnum, TEXT("/Script/OceanPlugin"), TEXT("EFollowMethod"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UInfiniteSystemComponent, 822357159);
...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFTimeDate
{
	...
	IMPLEMENT_CLASS(ATimeManager, 4088064947);
	void UWaterHeightmapComponent::StaticRegisterNativesUWaterHeightmapComponent()
	{
	}
	IMPLEMENT_CLASS(UWaterHeightmapComponent, 2415440796);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAdvancedBuoyancyComponent(Z_Construct_UClass_UAdvancedBuoyancyComponent, &UAdvancedBuoyancyComponent::StaticClass, TEXT("UAdvancedBuoyancyComponent"), false, nullptr, nullptr, nullptr);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_OceanPlugin_EFollowMethod()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("LookAtLocation")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FollowCamera")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("FollowPawn")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("Stationary")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFollowMethod_MAX")), 4));
	...
	uint32 Get_Z_Construct_UEnum_OceanPlugin_EFollowMethod_CRC() { return 2189457762U; }
